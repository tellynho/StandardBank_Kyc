...
Route::group([
	...
	Route::get ('/applications/kyc', [KycController::class,'index'])->name('homeIndex');
	// Route::get ('/application/kyc', [KycController::class,'index'])->name('homeIndex');
	Route::get ('/app/kyc/external', 'KycController@external')->name('external');
});
...
Route::get('/pt','KycController@lanDeIndex')->name('lang.pt')->middleware('auth');

///////////////////////////////////////////////////////////
Route::get ('/applications/getentries', [KycController::class,'getentries'])->name('getEntries')->middleware('auth');
